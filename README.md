...
## 推しポイント
- レベルによって変わるシンボルの装飾
  - レベルを上げるために、歩きたくなる！~車は甘え~
- 歩数のカウントにpedometerを使用しているため、車でズルができない
- シンボルが**キラキラ**でかわいい
...
### 開発における工夫した点
- ある程度明確に役割を線引し、役割内で実装責任を持つ 
  - 多少のタスクのムラはあったとは思うが、比較的ちゃんと作業分担ができた
...
### その他開発に使用したツール・サービス
- Github
- [Figma](https://www.figma.com/design/nuJ3zRCwtEadlMZm75Wjld/Power-s_app?node-id=0-1&t=HaR4CqoibsBOUmIP-1)
- Adobe Illustrator
- Adobe Photoshop
- ChatGPT
- Github Copilot
